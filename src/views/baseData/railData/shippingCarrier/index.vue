		...
		<el-dialog :title="title" :visible.sync="open" :lock-scroll="true" width="600px" @close="dialogClose">
			<el-form ref="createItemForm" :rules="rules" :model="createItem" label-suffix=":">
				<el-form-item label="船司代码" label-width="100px" prop="carrierCode">
					<el-input style="width: 80%" size="mini" :disabled="createItem.carrierId != ''" v-model="createItem.carrierCode"></el-input>
				</el-form-item>
				...
				<el-form-item label="中文简称" label-width="100px" prop="shortCname">
					<el-input style="width: 80%" size="mini" v-model="createItem.shortCname"></el-input>
				</el-form-item>
				<el-form-item label="英文简称" label-width="100px" prop="shortEname">
					<el-input style="width: 80%" size="mini" v-model="createItem.shortEname"></el-input>
				</el-form-item>
				<el-form-item label="SCAC代码" label-width="100px" prop="scac">
					<el-input style="width: 80%" size="mini" v-model="createItem.scac"></el-input>
				</el-form-item>
        <el-form-item label="船司官网" label-width="100px" prop="webUrl">
					<el-input style="width: 80%" size="mini" v-model="createItem.webUrl"></el-input>
				</el-form-item>
...
<script>
import { shippingCarrierList, shippingCarrierSave } from '@/api/baseData'
	...
	methods: {
		...
		submitForm(formName) {
			this.$refs[formName].validate(valid => {
				if (valid) {
					shippingCarrierSave(this.createItem).then(res => {
