...
// 拖柜派送委托列表new
export function fclIntrustListWithLoadInfo(data) {
  return request({
    url: '/order/shipping/delivery/fcl/intrust/listWithLoadInfo',
    method: 'post',
    data
  })
}
...
// 拖柜派送推送海外客服
export function pushToEcs(data) {
  return request({
    url: '/order/shipping/delivery/fcl/pushToEcs',
    method: 'post',
    data
  })
}
...
// 拖柜派送复制
export function fclIntrustCopy(data) {
  return request({
    url: '/order/shipping/delivery/fcl/intrust/copy',
    method: 'post',
    data
  })
}
